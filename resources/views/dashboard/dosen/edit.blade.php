    ...
    <div class="col-lg-8">
        <form action="/dashboard/dosen/{{ $dosen->id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="inputName" value="{{ old('name', $dosen->name) }}">
                @error('name')
              ...
              <div class="mb-3">
                ...
                <input type="number" name="npm" class="form-control @error('npm') is-invalid @enderror" id="inputnpm" value="{{ old('npm', $dosen->npm) }}">
                @error('npm')
              ...
              <div class="mb-3">
                ...
                <input type="hidden" name="oldImage" value="{{ $dosen->image_dosen }}">
                @if($dosen->image_dosen)
                <img src="{{ asset('storage/'.$dosen->image_dosen) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                @else
