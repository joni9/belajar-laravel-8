    ...
    <div class="col-lg-8">
        <form action="/dashboard/posts/{{ $post->slug }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="inputTitle" value="{{ old('title', $post->title) }}">
                @error('title')
              ...
              <div class="mb-3">
                ...
                <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" id="inputSlug" readonly  value="{{ old('slug', $post->slug)}}">
                @error('slug')
              ...
              <div class="mb-3">
                ...
                <input type="hidden" name="oldImage" value="{{ $post->image_post }}">
                @if($post->image_post)
                <img src="{{ asset('storage/'.$post->image_post) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                @else
            ...
            <div class="mb-3">
              ...
              <input id="description" type="hidden" name="description" class="@error('description') is-invalid @enderror" value="{{ old('description', $post->description) }}">  
